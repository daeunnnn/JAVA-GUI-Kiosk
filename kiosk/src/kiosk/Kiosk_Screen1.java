...
public class Kiosk_Screen1 extends Frame implements ActionListener {
...
Label lbTitle = new Label ("BIG COFFEE");
	...
	void image() {
		imgEspresso = Toolkit.getDefaultToolkit().getImage("img/에스프레소.png");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==btnEspresso) {
			imgSel = Toolkit.getDefaultToolkit().getImage("img/에스프레소.png");
